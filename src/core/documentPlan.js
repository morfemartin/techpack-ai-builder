...
export async function planPageLayout(pageOutline, context, { onProgress } = {}) {
  ...
  const instructions =
    ...
    "3) Composicion: para poner bloques LADO A LADO usá el compositor \"split\" (su array \"regions\" son columnas, cada una con weight = ancho relativo). Componé asimetrico tipo ficha: specs/lista angosta junto a ilustracion ancha. Variá la silueta segun el proposito - no hagas todas las paginas igual.\n" +
    ...
    "Ejemplo (overview de un hoodie): {\"regions\":[{\"type\":\"header\",\"weight\":10},{\"type\":\"titleBar\",\"weight\":5},{\"type\":\"split\",\"weight\":75,\"regions\":[{\"type\":\"partsList\",\"weight\":32},{\"type\":\"illustration\",\"weight\":68,\"slots\":2,\"refs\":[\"Frente\",\"Espalda\"],\"briefs\":[{\"garmentPart\":\"Prenda completa\",\"view\":\"Frente plano\",\"mustMark\":[\"bolsillo canguro\",\"cordon y ojales\",\"costura de hombro caido\"],\"measurements\":[{\"label\":\"Largo total desde hombro\",\"perSize\":true},{\"label\":\"Ancho bolsillo canguro\",\"perSize\":false}],\"placementLandmark\":\"\",\"factoryNote\":\"Puntadas visibles del canguro: doble aguja\"},{\"garmentPart\":\"Prenda completa\",\"view\":\"Espalda plana\",\"mustMark\":[\"union de capucha\",\"dobladillo\"],\"measurements\":[],\"placementLandmark\":\"\",\"factoryNote\":\"\"}]}]},{\"type\":\"disclaimer\",\"weight\":8}]}\n\n" +
    "Devolve SOLO JSON valido con esta forma exacta, sin markdown:\n" +
