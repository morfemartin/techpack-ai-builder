...
export const UI = {
  ES: {
    ...
    generateSourceSvg: "Generar SVG original",
  ...
  EN: {
    ...
    generateSourceSvg: "Generate original SVG",
...
export const T = {
  ...
  TR: {
    steps: ["Giysi", "Diller", "Başlık", "Parçalar", "Tasarımlar", "Önizleme", "Beden tablosu"],
    garmentStep: "Bu teknik föy için giysi türünü seçin:",
    langStep: "Fabrika için dil veya dilleri seçin:",
    brand: "Marka", season: "Sezon", sno: "Model Kodu", cat: "Kategori", fab: "Kumaş", fac: "Fabrika",
    ind: "Giriş Tarihi", outd: "Çıkış Tarihi", pname: "Ürün Adı",
    nxt: "İleri", bk: "Geri", gen: "Oluştur",
    sp: "ÖZELLİKLER", dt: "DETAYLAR",
    vw: ["1. ÖN GÖRÜNÜŞ", "2. ARKA GÖRÜNÜŞ", "3. SOL GÖRÜNÜŞ", "4. SAĞ GÖRÜNÜŞ"],
    illZone: "İLLÜSTRASYON ALANI - çizimi buraya yerleştirin",
    cats: ["Aksesuar", "Üst Giyim", "Alt Giyim", "Ayakkabı", "Diğer"],
    tecs: ["3D Nakış", "Düz Nakış", "Süblimasyon", "Baskı", "Dokuma Arma", "Jakarlı Dokuma", "Boyama"],
    pageDesign: "Tasarım",
    disc: "Tüm tasarımların münhasır telif hakkı", discSfx: " kuruluşuna aittir. Tüm hakları saklıdır.",
    embTitle: "Nakış Teknik Föyü",
    sizeChartTitle: "Ölçü Tablosu",
    posDetail: "Ayrıntılı Konum", wDes: "Tasarım Genişliği (mm)", hDes: "Tasarım Yüksekliği (mm)",
    noApplica: "Tasarım giysinin tamamını kaplar - ölçüler uygulanmaz",
    fileName: "Dosya Adı", driveLink: "Drive Bağlantısı",
    instructions: "TALİMATLAR", mark: "İşaretle", location: "Konum", dimension: "Ölçü çizgilerini çiz (mm)",
    factory: "Fabrika", reference: "Grafik referans mevcut - ÖLÇEKLİ DEĞİLDİR", pending: "ONAY BEKLİYOR",
  },
  ZH: {
